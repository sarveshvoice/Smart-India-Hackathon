...
import com.mygov.parivartan.smartindiahackathon.employee.adapter.ViewPageAdapter;
...
public class EmployeeProfile extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new ViewPageAdapter(getApplicationContext(),this.getSupportFragmentManager());
